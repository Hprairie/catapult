...
def fused_layernorm_tk(x, residual, norm_weight, norm_bias, B, N, D, dropout_p=0.0):
    # Move validation checks from C++ to Python
    ...
    fused_layernorm_tk.kernel(
        x, residual, norm_weight, norm_bias, o, o_resid, V=dropout_p, D=D
    )
    return o, o_resid
...
if __name__ == "__main__":
    ...
    o, o_resid = fused_layernorm_tk(x, residual, norm_weight, norm_bias, B, N, D, dropout_p=0.1)
